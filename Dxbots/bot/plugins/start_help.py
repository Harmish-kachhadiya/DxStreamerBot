        ...
        try:
            ...
            if user.status == "kicked":
             ...
             await DxStreamBot.send_photo(
                chat_id=m.chat.id,
                photo="https://graph.org/file/d49233c29c29bb4b01505.jpg",
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<i>Something went wrong</i> <b> <a href='https://t.me/h_k_Bots'>CLICK HERE FOR SUPPORT </a></b>",
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [HK_Bots](https://t.me/h_k_Bots).",
                disable_web_page_preview=True)
            return
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ Owner", url="https://t.me/h_k_Bots")],
                [InlineKeyboardButton("🎬 Movie channel", url="https://t.me/main_movie_hub")]
            ]
        )
    )
